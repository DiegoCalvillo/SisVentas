...
namespace CapaPresentacion
{
    public partial class frmCategoria : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(this.txtNombre, "Ingrese el ombre de la categoria");
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        rpta = NCategoria.Editar(Convert.ToInt32(this.txtCodigo.Text), this.txtNombre.Text.Trim().ToUpper(), this.txtDescripcion.Text.Trim());
                    }
